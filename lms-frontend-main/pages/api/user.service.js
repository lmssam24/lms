...
const getAssignmentMaterialList = () => {
  return api
    .get("/student_assignment_material_list")
    .then((response) => {
      return response;
    })
    .catch((error) => {
...
const submitAssignment = (assignemntData) => {
  return api
    .post("/submit_assignment", assignemntData)
    .then((response) => {
      return response;
    })
    .catch((error) => {
...
const getQuizQuestionList = (id) => {
  return api
    .get(`/student_quiz_question_list?id=${id}`)
    .then((response) => {
      return response;
    })
    .catch((error) => {
